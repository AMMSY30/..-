...
/**
 * Implements {@code /economy take <player> <amount>}.
 */
public final class TakeCommand implements Subcommand {
    ...
    public TakeCommand(Plugin plugin, EconomyManager economyManager, MessageManager messages) {
        this.plugin = plugin;
    ...
    public String getPermission() {
        return PermissionManager.ADMIN_TAKE;
    }

    @Override
    public String getUsage() {
        return "/economy take <player> <amount>";
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        economyManager.getAccount(targetName).thenAccept(accountOpt -> Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            economyManager.adminTake(account.getPlayerId(), amountOpt.get(), sender.getName())
                    .thenAccept(result -> Bukkit.getScheduler().runTask(plugin, () -> {
                        ...
                        messages.send(sender, "admin.take", "amount", formatted, "player", account.getPlayerName());
