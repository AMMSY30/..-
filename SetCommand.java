...
/**
 * Implements {@code /economy set <player> <amount>}.
 */
public final class SetCommand implements Subcommand {
    ...
    public SetCommand(Plugin plugin, EconomyManager economyManager, MessageManager messages) {
        this.plugin = plugin;
    ...
    public String getPermission() {
        return PermissionManager.ADMIN_SET;
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        economyManager.getAccount(targetName).thenAccept(accountOpt -> Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            economyManager.adminSet(account.getPlayerId(), amountOpt.get())
                    .thenAccept(result -> Bukkit.getScheduler().runTask(plugin, () -> {
                        ...
                        messages.send(sender, "admin.set", "amount", formatted, "player", account.getPlayerName());
